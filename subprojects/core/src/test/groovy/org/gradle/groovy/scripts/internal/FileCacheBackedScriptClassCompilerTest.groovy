...
class FileCacheBackedScriptClassCompilerTest extends Specification {
    ...
    def "loads classes from cache directory"() {
        ...
        1 * cacheRepository.cache("scripts-remapped/ScriptClassName/83/5963e90a85f2a728752d2c95fa6b7982") >> localCacheBuilder
        ...
        1 * cacheRepository.cache('scripts/83/TransformerId/5963e90a85f2a728752d2c95fa6b7982') >> globalCacheBuilder
    ...
    def "passes CacheValidator to cache builders"() {
        ...
        cacheRepository.cache("scripts-remapped/ScriptClassName/83/5963e90a85f2a728752d2c95fa6b7982") >> localCacheBuilder
