...
class ModuleTest extends Specification {
    ...
    def loadFromReader() {
        ...
        then:
        module.jdkName == "1.6"
        module.languageLevel == new IdeaLanguageLevel("1.5")
    ...
    def configureOverwritesDependenciesAndAppendsAllOtherEntries() {
        ...
        def constructorLanguageLevel = new IdeaLanguageLevel(JavaVersion.VERSION_1_5.toString())
        ...
        module.languageLevel == constructorLanguageLevel
